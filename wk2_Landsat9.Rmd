...
<div style="display: flex; justify-content: space-around; align-items: flex-start; text-align: right;">
  <figure style="margin: 0 0px; flex-basis: calc(55% - 5px);">
    <figcaption style="font-size: 24px; text-align: middle;">
      <ul style="list-style-type: disc; padding-left: 0; margin: 5px 0; text-align: left;">
        <li style="font-size: 20px;">The primary objectives of Landsat 9 include continuous monitoring of the Earth's surface, providing high-resolution Earth imaging data, and supporting various scientific research and applications such as land use monitoring, agriculture, forestry, urban planning, and environmental management.</li>
      </ul>
    </figcaption>
  </figure>
